...
class Terkey:
  ...
  def banner(self):
      os.system('clear')
      print(f'{c}Key Control {a}[{c}Termux{a}]'.center(68))
      print(f'{a}By Beereva'.center(53))
  ...
  def about(self):
    ...
    print(f"""
    {a}W E L C O M E  !{c}
    This is Key Control, the Termux shortcut !
    ...
    * Telegram  : {a}https://t.me/beereva{c}
    * Facebook  : {a}https://fb.me/beereva.id{c}
    * Instagram : {a}https://ig.me/beereva.id{c}
    * Blog      : {a}https://beereva.id{c}
    * Youtube   : {a}https://youtube.com/c/beereva{c}
    And if you want to give me some money, you can visit
    {a}https://saweria.co/beereva{c}
    """
    )
